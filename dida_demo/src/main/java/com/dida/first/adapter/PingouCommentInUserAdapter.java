 ...
 * 拼购评论Inner Item
 */
public class PingouCommentInUserAdapter extends BaseLvGvAdapter<BeanDetailPingouUser.ResEntity.ComGroupDetailEntity.ReplysEntity.SubReplysEntity> {
    public PingouCommentInUserAdapter(List<BeanDetailPingouUser.ResEntity.ComGroupDetailEntity.ReplysEntity.SubReplysEntity> list, Activity activity) {
        super(list, activity);
    }
