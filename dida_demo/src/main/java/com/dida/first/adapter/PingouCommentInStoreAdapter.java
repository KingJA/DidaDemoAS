 ...
 * 拼购评论Inner Item
 */
public class PingouCommentInStoreAdapter extends BaseLvGvAdapter<BeanDetailPingouStore.ResEntity.ComGroupDetailEntity.ReplysEntity.SubReplysEntity> {
    public PingouCommentInStoreAdapter(List<BeanDetailPingouStore.ResEntity.ComGroupDetailEntity.ReplysEntity.SubReplysEntity> list, Activity activity) {
        super(list, activity);
    }
    ...
    protected View baseGetView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = View
                    .inflate(activity, R.layout.include_commenet_pingou_in, null);
