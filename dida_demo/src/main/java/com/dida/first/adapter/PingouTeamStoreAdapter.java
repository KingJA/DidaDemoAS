 ...
 * 拼购已经参与的团员列表
 */
public class PingouTeamStoreAdapter extends BaseLvGvAdapter<BeanDetailPingouStore.ResEntity.ComGroupDetailEntity.ParticipatesEntity> {
    public PingouTeamStoreAdapter(List<BeanDetailPingouStore.ResEntity.ComGroupDetailEntity.ParticipatesEntity> list, Activity activity) {
        super(list, activity);
    }
