...
public class Market_Service_Fragment extends Base_First_Fragment {
    ...
    public View setFragmentView() {
        view = View.inflate(getActivity(), R.layout.fr_market_service, null);
        return view;
    }

    @Override
    public void initFragmentView() {
        plv = (PullToRefreshListView) view.findViewById(R.id.plv_market_service);
    }
