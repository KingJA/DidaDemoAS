 ...
 * @use
 */
public class PopupWindowParamMarket extends PopupWindowBaseDown<List<BeanDetailMarket.ResEntity.ProductCustomAttrListEntity>> {
     ...
     * @param data
     */
    public PopupWindowParamMarket(View parentView, Activity activity,
